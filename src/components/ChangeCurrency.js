...
const ChangeCurrency=() =>{
    ...
    return(
        <div>
            ...
            <select class="btn btn-success dropdown-toggle align-baseline border-0" name="Location" id="Location" onChange={event=>ChangeCurrency(event.target.value)}>
              <option class="list-group-item list-group-item-success" value="£">£ pound</option>
              <option class="list-group-item list-group-item-success" value="₹">₹ Ruppe</option>
